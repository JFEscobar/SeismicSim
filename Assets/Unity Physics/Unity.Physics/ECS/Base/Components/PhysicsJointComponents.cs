...
namespace Unity.Physics
{
    ...
    public struct PhysicsJoint : IComponentData
    {
        ...
        public static PhysicsJoint CreateFixed(BodyFrame bodyAFromJoint, BodyFrame bodyBFromJoint,
            float springFrequency = Constraint.DefaultSpringFrequency, float dampingRatio = Constraint.DefaultDampingRatio) =>
            new PhysicsJoint
        {
            BodyAFromJoint = bodyAFromJoint,
            BodyBFromJoint = bodyBFromJoint,
            ...
            {
                Length = 2,
                A = Constraint.BallAndSocket(springFrequency),
                B = Constraint.FixedAngle(dampingRatio)
            }
        };
